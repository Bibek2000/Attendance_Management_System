...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
            ...
            <div class="sidebar-brand-text mx-3">Attendance Management System</div>
        </a>
        ...
        <li class="nav-item">
            ...
            <div id="collapseTwo2" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <a class="collapse-item" href="{{url('/backend/program/create')}}">Create</a>
                    <a class="collapse-item" href="{{'/backend/program'}}">List</a>
                </div>
            </div>
        </li>
        ...
        <li class="nav-item">
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <a class="collapse-item" href="{{url('/backend/batch/create')}}">Create</a>
                    <a class="collapse-item" href="{{'/backend/batch'}}">List</a>
                </div>
            </div>
        </li>
        ...
        <li class="nav-item">
            ...
            <div id="collapsePage4" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <a class="collapse-item" href="{{url('/backend/course/create')}}">Create</a>
                    <a class="collapse-item" href="{{'/backend/course'}}">List</a>
                </div>
            </div>
        </li>
        ...
        <li class="nav-item">
            ...
            <div id="collapsePage1" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <a class="collapse-item" href="{{url('/backend/student/create')}}">Create</a>
                    <a class="collapse-item" href="{{'/backend/student'}}">List</a>
                </div>
            </div>
        </li>
